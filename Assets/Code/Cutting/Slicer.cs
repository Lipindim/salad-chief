...
namespace Assets.Scripts
{
    class Slicer
    {
        ...
        {            
            ...
            //positiveObject.transform.position += new Vector3(0, 0, 0.01f);
            ...
            Vector3 objectToCutVelocity = objectToCut.GetComponent<Rigidbody>().velocity;
            SetupCollidersAndRigidBodys(ref positiveObject, positiveSideMeshData, sliceable.UseGravity, objectToCutVelocity);
            SetupCollidersAndRigidBodys(ref negativeObject, negativeSideMeshData, sliceable.UseGravity, objectToCutVelocity);
        ...
        private static void SetupCollidersAndRigidBodys(ref GameObject gameObject, Mesh mesh, bool useGravity, Vector3 velocity)
        {                     
